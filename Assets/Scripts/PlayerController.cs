...
public class PlayerController : MonoBehaviour
{
    ...
    private IEnumerator Shoot()
    {
        ...
        ammoUI.FireShot();
        ammo.Use();
        CheckClip(ammoUI.currentClipSize);
    }
    ...
    public void EndPickup()
    {
        ...
        Debug.Log("EndPickup event triggered!");
    }

    public void CheckClip(int clip)
    {
        if (clip == 0)
        {
            StartCoroutine(Reload());
